...
public class Employees  implements java.io.Serializable {
    ...
    public Employees(int employeeId, String firstName, String lastName, String email, String phoneNumber, Date hireDate, Jobs jobs, BigDecimal salary, BigDecimal commissionPct, Employees employees, Departments departments) {
        this.employeeId = employeeId;
